...
struct FreePlanCard: View { var body: some View { ZStack { RoundedRectangle(cornerRadius: 16).fill(Color.yellow.opacity(0.12)).overlay(RoundedRectangle(cornerRadius:16).stroke(Color.yellow.opacity(0.35))) ; VStack(alignment:.leading, spacing: 12){ HStack{ Image(systemName:"crown.fill").foregroundStyle(.yellow); Text("Free Plan").font(.headline); Spacer(); Label("View Only", systemImage: "eye").font(.caption).padding(6).background(Capsule().fill(Color.white.opacity(0.5))) } ; HStack{ Button("Try Free"){}.buttonStyle(.borderedProminent); Button("Upgrade"){ }.buttonStyle(.bordered).tint(.orange) } ; HStack(spacing:16){ Label("Unlimited invoices", systemImage:"checkmark"); Label("Premium templates", systemImage:"checkmark"); Label("Advanced features", systemImage:"checkmark") }.font(.caption).foregroundStyle(.secondary) }.padding(16) } } }
